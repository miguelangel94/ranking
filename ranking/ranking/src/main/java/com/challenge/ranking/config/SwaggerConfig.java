/*package com.challenge.ranking.config;

import com.challenge.ranking.utils.RestConstants;
...
public class SwaggerConfig {
	...
	private ApiInfo apiInfo() {
		return new ApiInfoBuilder().title("Ranking").description("Ranking Series Api")
				.version("1.0").build();
	}
}
*/